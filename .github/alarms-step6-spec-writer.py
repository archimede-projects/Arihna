...
old_header = "### 5.5 Alarms — MILESTONE OPEN / STEP 1 SPEC-FIRST CLOSED"
new_header = "### 5.5 Alarms — MILESTONE OPEN / STEP 5 CLOSED / STEP 6 AUTHORIZED"
assert old_header in text, "Alarms header marker not found"
text = text.replace(old_header, new_header, 1)

marker = "STEP 6 is not started by this authorization.\n\n#### Alarms milestone sequence"
assert marker in text, "STEP 6 authorization marker not found"

section = """STEP 6 is not started by this authorization.
...
for old, new in replacements.items():
    assert old in text, f"sequence marker not found: {old}"
