...
import com.archimedeprojects.arihna.core.location.platform.FusedDeviceLocationDataSource
...
class AppContainer(context: Context) {
    ...
    val deviceLocationDataSource: DeviceLocationDataSource by lazy { FusedDeviceLocationDataSource(appContext) }
